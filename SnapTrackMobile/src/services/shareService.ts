...
export class ShareService {
  ...
  async shareReceiptImage(receipt: Receipt): Promise<boolean> {
    try {
      if (!receipt.receipt_url) {
        // For receipts without images (like text receipts), share text summary
        return await this.shareReceiptText(receipt);
      }
  ...
  /**
   * Share receipt as text when no image is available
   */
  async shareReceiptText(receipt: Receipt): Promise<boolean> {
    try {
      // Check if sharing is available
      const isAvailable = await Sharing.isAvailableAsync();
      if (!isAvailable) {
      ...
      // Create text summary of the receipt
      const receiptText = this.generateReceiptTextSummary(receipt);
      ...
      console.log('✅ Receipt text shared successfully');
      return true;
    } catch (error: any) {
      console.error('❌ Failed to share receipt text:', error);
      ...
      Alert.alert('Share Error', 'Unable to share receipt details. Please try again.');
      return false;
    }
  }
  ...
  /**
   * Generate a text summary of the receipt for sharing
   */
  private generateReceiptTextSummary(receipt: Receipt): string {
    ...
    let summary = `📧 SnapTrack Receipt\n`;
    summary += `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n`;
    
    summary += `💰 Amount: $${receipt.amount.toFixed(2)}\n`;
    summary += `🏪 Vendor: ${receipt.vendor || 'Unknown'}\n`;
    summary += `📅 Date: ${formatDate(receipt.date)}\n`;
    
    if (receipt.entity) {
      summary += `🏢 Entity: ${receipt.entity}\n`;
    }
    
    if (receipt.tags && receipt.tags.length > 0) {
      summary += `🏷️ Tags: ${receipt.tags.join(', ')}\n`;
    }
    ...
    if (receipt.extraction_method === 'text' && receipt.email_subject) {
      summary += `📧 Email Subject: ${receipt.email_subject}\n`;
    }
    
    summary += `\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n`;
    summary += `Generated by SnapTrack - Smart Receipt Processing\n`;
